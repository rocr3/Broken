...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001884688471')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001884688471')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/MOVIES_PROVIDE/11')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001884688471')).split()]
